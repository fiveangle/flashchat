...
FLASHCHAT_CONFIG_SCHEMA_VERSION="15"
...
FLASHCHAT_DEFAULT_CONVERSATION_CACHE="1"
...
_flashchat_migrate_config() {
    ...
    for key in MODEL HUGGINGFACE_CACHE_DIR OFFLOAD_DIR MAX_TOKENS SAMPLING_PROFILE \
               ...
               CONVERSATION_CACHE SYSTEM_PROMPT_CACHE SYSTEM_PROMPT_CACHE_MAX_ENTRIES SYSTEM_PROMPT_CACHE_DIR MTP MTP_BF16 ACTIVE_EXPERTS \
...
flashchat_load_config() {
    ...
    [ -n "$FLASHCHAT_CONVERSATION_CACHE" ] && CONVERSATION_CACHE="$FLASHCHAT_CONVERSATION_CACHE"
    ...
    CONVERSATION_CACHE="${CONVERSATION_CACHE:-$FLASHCHAT_DEFAULT_CONVERSATION_CACHE}"
...
flashchat_get() {
    ...
    case "$key" in
        ...
        CONVERSATION_CACHE) echo "$CONVERSATION_CACHE" ;;
